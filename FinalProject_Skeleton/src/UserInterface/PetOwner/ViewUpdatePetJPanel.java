 ...
 * @author shaoy
 */
public class ViewUpdatePetJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewUpdatePetJPanel
     */
    private JPanel userProcessContainer;
    private Pet pet;

    public ViewUpdatePetJPanel(JPanel userProcessContainer, Pet pet) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Update Pet Information");
        ...
        if (Utilities.isNameValid(name) && Utilities.checkAge(a)) {
            if (s.equals(Species.Other)) {
                if (txtOther.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Please fill your pet's species.");
                    return;
                }
            }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        ManagePetsJPanel managePetsJPanel = (ManagePetsJPanel) component;
        managePetsJPanel.populateTable();
